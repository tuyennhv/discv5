 ...
 */
export class KademliaRoutingTable extends EventEmitter {
    localId;
    buckets;
    /**
    ...
    update(value, status) {
        ...
        if (updateResult === UpdateResult.UpdatedPending ||
    ...
    insertOrUpdate(value, status) {
        ...
        if (!bucket.get(id)) {
            ...
            if ((updateValue === UpdateResult.Updated && updateStatus === UpdateResult.NotModified) ||
