...
import { createFindNodeMessage } from "../message/index.js";
import { LookupState, LookupPeerState } from "./types.js";
import { distance, findNodeLog2Distances } from "./util.js";
export function createLookupPeer(nodeId, state) {
    return {
        nodeId,
        peersReturned: 0,
        state,
...
export class Lookup extends EventEmitter {
    ...
    constructor(config, nodeId, closestPeers) {
        ...
        this.closestPeers = new Map(closestPeers
            ...
            .map((n) => [distance(nodeId, n), createLookupPeer(n, LookupPeerState.NotContacted)]));
