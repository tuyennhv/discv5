...
import { ISessionEvents, ISessionConfig } from "./types.js";
...
export declare class SessionService extends SessionService_base {
     ...
     */
    sendRequest(contact: NodeContact, request: RequestMessage): Promise<void>;
    /**
     * Sends an RPC response
     */
    sendResponse(nodeAddr: INodeAddress, response: ResponseMessage): Promise<void>;
    /**
     ...
     */
    sendChallenge(nodeAddr: INodeAddress, nonce: Buffer, remoteEnr: ENR | null): Promise<void>;
    processInboundPacket: (src: Multiaddr, packet: IPacket) => Promise<void>;
