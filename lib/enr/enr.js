...
class ENR extends Map {
    ...
    get ip() {
        ...
        if (raw) {
            return convert_1.default.toString(multiaddr_1.protocols.names.ip4.code, util_1.toNewUint8Array(raw));
        }
        else {
            return undefined;
        }
    ...
    get ip6() {
        ...
        if (raw) {
            return convert_1.default.toString(multiaddr_1.protocols.names.ip6.code, util_1.toNewUint8Array(raw));
        }
        else {
            return undefined;
        }
